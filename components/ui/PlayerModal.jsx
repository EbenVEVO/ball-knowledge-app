...
export const PlayerModal = ({ isVisible, onClose, stats, player, fixture }) => {
  ...
  if (isVisible) console.log(fixture);
  ...
  const StatItem = ({ label, value, width = "16.66%" }) => (
    <View style={{ width, paddingVertical: 6, alignItems: "center", gap: 2 }}>
      <Text className="font-supremeBold">{value ?? 0}</Text>
                    ...
                    ListHeaderComponent={
                      <View style={{ padding: 20}}>
                        <View style={{position: "absolute",
                            top: 20,
                            right: 20,
                            zIndex: 50,flexDirection:'row', gap:10 }}>
                        <Pressable
                            ...
                            <Pressable style={{ alignItems: "center" }}>
                              ...
                              >
                                ...
                                {playerStats?.rating > 0 && (
                                  ...
                                  >
                                    ...
                                    >
                                      {parseFloat(playerStats?.rating).toFixed(
                                        1,
                                      )}
                                    </Text>
                                  </View>
                              ...
                              <View>
                                <View className="flex flex-row gap-2 items-center justify-center pt-2">
                                  ...
                                  <Image
                                    source={playerStats?.player?.flag?.flag_url}
                                    style={{
                                      width: 20,
                                      height: 20,
                                      borderRadius: 10,
                          ...
                          <View className="p-2">
                            <TouchableOpacity
                              ...
                              onPress={() => {
                                ...
                                reactionButtonRef.current?.measureInWindow(
                                  (x, y, width, height) => {
